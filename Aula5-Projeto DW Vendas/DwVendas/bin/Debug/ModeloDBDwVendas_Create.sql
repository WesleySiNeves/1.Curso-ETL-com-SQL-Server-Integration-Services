/*
Deployment script for ModeloDBDwVendas
...
GO
:setvar DatabaseName "ModeloDBDwVendas"
:setvar DefaultFilePrefix "ModeloDBDwVendas"
...
GO
PRINT N'Creating Schema [Dimensao]...';
...
GO
PRINT N'Creating Table [Dimensao].[D_Categorias]...';
...
CREATE TABLE [Dimensao].[D_Categorias] (
    ...
    [DataAlteracao] DATETIME2 (2) NOT NULL,
    [teste]         INT           NULL,
    CONSTRAINT [PK_DimensaoCategorias] PRIMARY KEY CLUSTERED ([SK_Categoria] ASC)
);
...
GO
ALTER TABLE [Dimensao].[D_Produtos]
